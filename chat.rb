...
loop do
    ...
    Thread.start(server.accept) do |client|
        ...
        client.puts "Bienvenido a nuestro servidor de chat! Cual es tu nombre?"
        ...
        client.puts "Estas conectado con #{connected_clients.length} otros usuarios: [#{other_client_names.join(',')}]"
